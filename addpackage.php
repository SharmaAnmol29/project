    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3 mt-4 ">
            <div class="card-body offcanvas-body shadow-lg" style="border-radius:1rem">
                <form method="post" action="addpackageaction.php">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <h2 class="text-center" style="color: #263944">Add New Package</h2>
                            <input class="form-control" type="name" name="packagename" id="packagename"
                                   placeholder="Enter Package Name">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <input class="form-control" type="name" name="packageprice" id="packageprice"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <input type="submit" value="Submit" class="btn text-white text-center "
